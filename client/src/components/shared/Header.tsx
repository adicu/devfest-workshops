    ...
    <div className="flex justify-between items-center px-6 md:px-20 py-4">
      ...
      <div className="flex justify-end">
        ...
        <SignedOut>
          ...
          <Link href="/sign-in" type="button" className="self-center float-right bg-green-500 justify-end text-white text-xs px-8 sm:px-6 py-2 sm:py-1 rounded-full no-underline font-bold inline-block">Sign Up</Link>
        </SignedOut>
